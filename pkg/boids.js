...
* @param {number} width
*/
export function send_context(ctx, height, width) {
    wasm.send_context(addHeapObject(ctx), height, width);
}
...
*/
export function request_frame(delta_time) {
    wasm.request_frame(delta_time);
}
